...
exports.useArtDirection = exports.useImageLoaded = exports.getPlaceholderProps = exports.getMainProps = exports.useGatsbyImage = exports.applyPolyfill = exports.getWrapperProps = exports.getSrc = exports.getImage = exports.hasImageLoaded = exports.storeImageloaded = exports.hasNativeLazyLoadSupport = void 0;
...
function useGatsbyImage(_a) {
    var _b = _a.pluginName, pluginName = _b === void 0 ? "useGatsbyImage" : _b, _c = _a.breakpoints, breakpoints = _c === void 0 ? image_utils_1.EVERY_BREAKPOINT : _c, args = __rest(_a, ["pluginName", "breakpoints"]);
    return image_utils_1.generateImageData(__assign({ pluginName: pluginName, breakpoints: breakpoints }, args));
}
 ...
 */
function useArtDirection(defaultImage, artDirected) {
    var _a, _b;
    var _c;
...
exports.useArtDirection = useArtDirection;
