...
function lazyHydrate(_a, root, hydrated) {
    ...
    var hasLoaded = !hydrated.current && hooks_1.hasImageLoaded(cacheKey);
    ...
    var component = (react_1["default"].createElement(layout_wrapper_1.LayoutWrapper, { layout: layout, width: width, height: height },
        ...
        react_1["default"].createElement(main_image_1.MainImage, __assign({}, props, { className: imgClassName }, hooks_1.getMainProps(isLoading, hasLoaded || isLoaded, images, loading, toggleIsLoaded, cacheKey, ref, imgStyle)))));
