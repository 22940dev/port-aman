...
exports.getDimensionsAndAspectRatio = exports.responsiveImageSizes = exports.fixedImageSizes = exports.calculateImageSizes = exports.generateImageData = exports.formatFromFilename = exports.getSrcSet = exports.getSizes = exports.EVERY_BREAKPOINT = exports.DEFAULT_BREAKPOINTS = void 0;
...
function generateImageData(args) {
    var pluginName = args.pluginName, sourceMetadata = args.sourceMetadata, generateImageSource = args.generateImageSource, _a = args.layout, layout = _a === void 0 ? "constrained" : _a, fit = args.fit, options = args.options, width = args.width, height = args.height, filename = args.filename, _b = args.reporter, reporter = _b === void 0 ? { warn: warn } : _b;
    if (!pluginName) {
...
function calculateImageSizes(args) {
    ...
    if (layout === "fixed") {
        ...
        reporter.warn("No valid layout was provided for the image at " + filename + ". Valid image layouts are fixed, fullWidth, and constrained.");
        return {
