    ...
    <section data-name="private" sx={{ position: `relative`, py: 6 }}>
      <Container>
        <div sx={{ maxWidth: `1200px` }}>
          ...
          Google is certified under the Privacy Shield Agreement and thus offers a guarantee of compliance with European data protection law <Themed.a href="https://www.privacyshield.gov/participant?id=a2zt000000001L5AAI&status=Active=a2zt000000001L5AAI&status=Active">(https://www.privacyshield.gov/participant?id=a2zt000000001L5AAI&status=Active=a2zt000000001L5AAI&status=Active) </Themed.a> 
          <br /><br />
