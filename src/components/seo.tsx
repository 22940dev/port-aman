...
const SEO = ({
  ...
  const orgaCreator = (input: string) => ({
    ...
    sameAs: [
      `https://www.linkedin.com/in/amankalra172/`,
      `https://github.com/amankalra172`,
      `https://www.facebook.com/amankalra172`,
      `https://www.instagram.com/amankalra172/`,
      `https://twitter.com/amankalra172`,
      ],
  })
  ...
  return (
    <Helmet meta={meta}>
      ...
      <meta name="twitter:data1" value="https://www.amankalra.com" />
